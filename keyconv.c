				...
				fprintf(stderr,
					...
					break;
                        ...
                        if (strcmp(optarg, "LTB")== 0) {
                                fprintf(stderr,
                                        "Decrypting Litebar Coin Address\n");
                                        addrtype = 48;
                                        privtype = 176;
                                        break;
                        }
                        ...
                        if (strcmp(optarg, "BCF")== 0) {
                                fprintf(stderr,
                                        "Decrypting BitcoinFast Coin Address\n");
                                        addrtype = 25;
                                        privtype = 153;
                                        break;
                        }
                        ...
                        if (strcmp(optarg, "EMC2")== 0) {
                                fprintf(stderr,
                                        "Decrypting Einsteinium Coin Address\n");
                                        addrtype = 33;
                                        privtype = 176;
                                        break;
                        }
                        ...
                        if (strcmp(optarg, "BTB")== 0) {
                                fprintf(stderr,
                                        "Decrypting BitBar Coin Address\n");
                                        addrtype = 25;
                                        privtype = 153;
                                        break;
                        }
